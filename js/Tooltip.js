// original source: http://projects.flowingdata.com/tut/interactive_network_demo/js/Tooltip.js
function Tooltip(tooltipId, width, svgCanvasWidth){
  ...
  function updatePosition(event){
    ...
    */
    // Move the tooltip out of the way; ghetto, but seeing links is more important
    var ttleft = windowX + svgCanvasWidth + 20;
    var tttop = windowY;
